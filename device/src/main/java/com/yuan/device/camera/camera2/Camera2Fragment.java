...
public class Camera2Fragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_camera2, container, false);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_VIDEO_PERMISSIONS) {
            if (grantResults.length == VIDEO_PERMISSIONS.length) {
                ...
                ErrorDialog.newInstance("权限申请失败")
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("启动相机失败")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } catch (InterruptedException e) {
    ...
    private void startPreview() {
        ...
        try {
            ...
            if (mImageReader == null) {
                mImageReader = ImageReader.newInstance(mTextureView.getWidth(), mTextureView.getHeight(), ImageFormat.YUV_420_888, 1);
